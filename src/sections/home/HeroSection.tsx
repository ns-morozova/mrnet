...
const HeroSection = () => (
  <section className="max-w-7xl mx-auto space-y-2.5 px-5 md:px-9">
    <div className="flex flex-col gap-2.5 lg:flex-row-reverse lg:justify-between lg:gap-3">
      ...
      />
      <article className="bg-linear-to-r from-black to-accent-flame border border-accent-flame rounded-lg px-4 py-2.5 md:px-5 md:py-4">
